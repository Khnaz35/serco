...
class ControllerAccountSimpleRegister extends SimpleController {
    ...
    public function index($args = null) {
		...
		$this->_templateData['text_modal_close'] = $this->language->get('text_modal_close');
		$this->_templateData['text_modal_success'] = $this->language->get('text_modal_success');
		$this->_templateData['text_modal_warning'] = $this->language->get('text_modal_warning');
