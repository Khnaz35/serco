	...
	$_['text_latest']			 = 'Новинка';
	$_['text_bestseller']		 = 'Хит';
	$_['text_dimentions_table']	 = 'Таблица размеров';
	$_['text_rozn']				 = 'Розничная цена:';
	$_['text_mopt']				 = 'Мелкий опт:';
	$_['text_opt']				 = 'Оптовая цена:';
	$_['text_known']			 = 'Узнать';
	$_['text_known_opt']		 = 'Узнать оптовую цену';
	...
	$_['text_modal_success'] = 'Внимание!';
	$_['text_modal_warning'] = 'Внимание!';
	$_['text_choose_size']   = 'Выберите размер';
