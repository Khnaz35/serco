...
//$_['text_items']       = '<div class="count-box"><span class="count">%s</span><span class="handle"></span></div> <span class="count-price">%s</span>';
$_['text_items']       = '%s<!--%s-->';
...
$_['text_select_shipping_method'] = '--Выберите метод доставки--';
$_['text_shipping_methods'] = 'Способы доставки';

$_['text_comment'] = 'Комментарий к заказу и адрес доставки';
$_['text_your_order'] = 'ВАШ ЗАКАЗ';
$_['order_description'] = 'Наш менеджер перезвонит вам для уточнения деталей заказа.';
