...
<div class="container">
    ...
    <div class="row">
        ...
        <div id="content" class="<?php echo $class; ?>">
            ...
            <div class="page-content cart-page-content clearfix">
            
                <h4><?php if ($weight) { ?>(<?php echo $weight; ?>)<?php } ?></h4>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control noletters" />
                    <span class="input-group-btn">
                    <button type="submit" data-toggle="tooltip" title="<?php echo $button_update; ?>" class="btn btn-default btn-simple-counter"><i class="fa fa-refresh"></i></button>
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger btn-simple-remove" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times"></i></button>
                    </span></div></td>
