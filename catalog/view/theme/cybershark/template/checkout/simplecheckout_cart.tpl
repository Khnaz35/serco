        ...
        <table class="simplecheckout-cart">
            ...
            <?php foreach ($products as $product) { ?>
                ...
                <tr>
                    ...
                    <td class="quantity">
                        <div class="input-group btn-block" style="max-width: 200px;">
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-simple-counter" data-onclick="decreaseProductQuantity" data-toggle="tooltip" type="submit">
                                    <i class="fa fa-minus"></i>
                                </button>
                            </span>
                            <input class="form-control noletters" type="text" data-onchange="changeProductQuantity" name="quantity[<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" />
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-simple-counter" data-onclick="increaseProductQuantity" data-toggle="tooltip" type="submit">
                    ...
                    <td class="remove">
                                <button class="btn btn-danger btn-simple-remove" data-onclick="removeProduct" data-product-key="<?php echo !empty($product['cart_id']) ? $product['cart_id'] : $product['key'] ?>" data-toggle="tooltip" type="button">
