<div id="cart_fixed" class="btn-group btn-block">
 <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-block dropdown-toggle"><span id="cart-total"><?php echo $text_items; ?></span></button>
