    <?php if ($products) { ?>
        <div class="container-module container-product-carousel container-latest">
            <div class="title-module">
                <span><?php echo $heading_title; ?></span>
            </div>
            
            <div class="product-slider">
                <div class="container-modules latest carousel_numb_product_latest<?php echo $module_productlatest_number; ?> owl-carousel">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(".carousel_numb_product_latest<?php echo $module_productlatest_number; ?>").owlCarousel({
                    margin:0,
                    nav:true,
                    dots:false,
