    <?php if ($products) { ?>
        <div class="container-module container-product-carousel container-bestseller">
            <div class="title-module">
                <span><?php echo $heading_title; ?></span>
            </div>
            
            <div class="product-slider">
                <div class="container-modules bestseller carousel_numb_product_bestseller<?php echo $module_productbestseller_number; ?> owl-carousel">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(".carousel_numb_product_bestseller<?php echo $module_productbestseller_number; ?>").owlCarousel({
                    margin:0,
                    nav:true,
                    dots:false,
