<div class="categorywall-container">
    <?php if(!empty($heading_title[$lang_id]['title_name'])) { ?>
        <div class="title-module">
            <span><?php echo $heading_title[$lang_id]['title_name'];?></span>
        </div>
    <?php } ?>

	<div class="categorywall row">
        <?php $i = 1; ?>
        ...
        <?php foreach ($categories as $category) { ?>
            ...
            <?php } else{ ?>
                ...
                <?php $temp_class = 'one'; ?>
            <?php } ?>
            <div class="categorywall-item <?php echo($temp_class); ?>">
                <a href="<?php echo $category['href']; ?>" style="background-image: url('<?php echo $category['image']; ?>');">
                    <div class="categorywall-title-container">
                        <div class="categorywall-title">
...
<?php /* <div class="categorywall-container categorywall-<?php echo $module; ?> no-touch">	
<?php if(!empty($heading_title[$lang_id]['title_name'])) { ?>
