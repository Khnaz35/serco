    <?php if ($products) { ?>
        <div class="container-module container-product-carousel container-fromcategory">
            <div class="title-module">
                <span><?php echo $heading_title; ?></span>
            </div>
            
            <div class="product-slider">
                <div class="container-modules fromcategory carousel_numb_product_fromcategory<?php echo $module_productfromcategory_number; ?> owl-carousel">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(".carousel_numb_product_fromcategory<?php echo $module_productfromcategory_number; ?>").owlCarousel({
                    margin:0,
                    nav:true,
                    dots:false,
