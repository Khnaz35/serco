				...
				<div class="product">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-7">
								<div class="col-xs-6 quantity_quickorder quick-cell">
									<div class="quick-cell-content pquantity">
										<div class="input-group popup-quantity">
											...
											<input type="text" class="form-control input-sm qty_quickorder noletter" name="quantity" id="htop_quickorder" size="2" value="1" />
											<span class="input-group-btn">
                                ...
                                <script type="text/javascript">
                                    $('.noletter').bind("change keyup input click", function() {
                ...
                <div class="options">      
                    <?php foreach ($options as $option) { ?>
                        <?php if ($option['type'] == 'select') { ?>
                            <div id="option-fast-<?php echo $option['product_option_id']; ?>" class="fastoption-select-container col-sm-6 option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                <div class="text-danger option-error-<?php echo $option['product_option_id']; ?>">
                                </div>
                        ...
                        <?php if ($option['type'] == 'radio') { ?>
                            <div id="option-fast-<?php echo $option['product_option_id']; ?>" class="col-sm-12 col-xs-12 option form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
                                <div class="text-danger option-error-<?php echo $option['product_option_id']; ?>">
                                </div>
