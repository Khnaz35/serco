    <?php if ($products) { ?>
        <div class="container-module container-product-carousel container-featured">
            <div class="title-module">
                <span><?php echo $heading_title; ?></span>
            </div>
            
            <div class="product-slider">
                <div class="container-modules featured carousel_numb_product_featured<?php echo $module_productfeatured_number; ?> owl-carousel">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                $(".carousel_numb_product_featured<?php echo $module_productfeatured_number; ?>").owlCarousel({
                    margin:0,
                    nav:true,
                    dots:false,
