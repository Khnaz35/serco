        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="title-slug<?php echo $langC[$language['language_id']]; ?>" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="jan" id="input-jan" class="form-control">
                    <?php if ($jan == 0) { ?>
                        <option value="0" selected="selected"><?php echo $text_jan_0; ?></option>
                        <option value="1"><?php echo $text_jan_1; ?></option>
                        <option value="2"><?php echo $text_jan_2; ?></option>
                        <option value="3"><?php echo $text_jan_3; ?></option>
                    <?php } ?>
                    
                    <?php if ($jan == 1) { ?>
                        <option value="0"><?php echo $text_jan_0; ?></option>
                        <option value="1" selected="selected"><?php echo $text_jan_1; ?></option>
                        <option value="2"><?php echo $text_jan_2; ?></option>
                        <option value="3"><?php echo $text_jan_3; ?></option>
                    <?php } ?>
                    ...
                    <?php if ($jan == 2) { ?>
                        <option value="0"><?php echo $text_jan_0; ?></option>
                        <option value="1"><?php echo $text_jan_1; ?></option>
                        <option value="2" selected="selected"><?php echo $text_jan_2; ?></option>
                        <option value="3"><?php echo $text_jan_3; ?></option>
                    <?php } ?>
                    ...
                    <?php if ($jan == 3) { ?>
                        ...
                        <option value="1"><?php echo $text_jan_1; ?></option>
                        <option value="2"><?php echo $text_jan_2; ?></option>
                        <option value="3" selected="selected"><?php echo $text_jan_3; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <?php /*<div class="form-group<?php echo ($hide_jan == true)? ' hide':''; ?>">
