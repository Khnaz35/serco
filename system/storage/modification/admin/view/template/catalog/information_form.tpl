        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-information" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="title-slug<?php echo $langC[$language['language_id']]; ?>" name="information_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($information_description[$language['language_id']]) ? $information_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-bottom2"><span data-toggle="tooltip" title="<?php echo $help_bottom2; ?>"><?php echo $entry_bottom2; ?></span></label>
                <div class="col-sm-10">
                  <div class="checkbox">
                    <label>
                      <?php if ($bottom2) { ?>
                      <input type="checkbox" name="bottom2" value="1" checked="checked" id="input-bottom2" />
                      <?php } else { ?>
                      <input type="checkbox" name="bottom2" value="1" id="input-bottom2" />
                      <?php } ?>
                      &nbsp; </label>
                  </div>
                </div>
