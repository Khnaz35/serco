...
class ControllerCommonColumnLeft extends Controller
{
	...
	public function index()
	{
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/color')) {
                $catalog[] = array(
        			'name'	   => $this->language->get('text_color'),
        			'href'     => $this->url->link('catalog/color', 'token=' . $this->session->data['token'], true),
        			'children' => array()		
    			);
            }
			...
			if (false && $this->user->hasPermission('access', 'catalog/recurring')) {
				$catalog[] = array(
			...
			if (false &&$this->user->hasPermission('access', 'catalog/filter')) {
				$catalog[] = array(
			...
			if ($this->user->hasPermission('access', 'extension/module/brainyfilter')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_brainyfilter'),
					'href'     => $this->url->link('extension/module/brainyfilter', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if (false && $this->user->hasPermission('access', 'catalog/download')) {
				$catalog[] = array(
			...
			if ($this->user->hasPermission('access', 'catalog/shoplist')) {		
				$catalog[] = array(
					'name'	   => $this->language->get('text_shoplist'),
					'href'     => $this->url->link('catalog/shoplist', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);					
			}
        ...
        // end: OCdevWizard
			...
			$sale = array();
				...
				if ($this->user->hasPermission('access', 'sale/newfastorder')) {
					$sale[] = array(
						...
						'href'     => $this->url->link('sale/newfastorder', 'token=' . $this->session->data['token'], true),
						'children' => array()		
					);
				}
			...
			if (false && $this->user->hasPermission('access', 'sale/recurring')) {	
				$sale[] = array(
					'name'	   => $this->language->get('text_recurring'),
