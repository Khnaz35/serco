...
class ModelToolSimpleApiMain extends Model {
    static $data = array();
					...
					public function getShippingCities($zoneId) {
					    ...
					    if ($shipping_method == 'novaposhta.Warehouse' || $shipping_method == 'novaposhta.Doors') {
					...
					public function getShippingWarehouses($cityName) {
					    ...
					    if ($shipping_method == 'novaposhta.Warehouse') {
