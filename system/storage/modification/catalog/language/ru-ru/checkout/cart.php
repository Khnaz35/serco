...
// Text
$_['text_success']             = '<div class="popup-title">Товар <a class="hidden" href="%s">%s</a> добавлен в корзину <a class="hidden" href="%s">в корзину</a></div>';
            $_['text_success_name']             = '<div class="popup-product-name"><a href="%s">%s</a></div>';
