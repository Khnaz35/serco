...
class Pagination {
	...
	public function render() {
		...
		if ($page > 1) {
			...
			if ($page - 1 === 1) {
				$output .= '<li class="pagin-prev"><a href="' . str_replace(array('?page={page}', '&amp;page={page}'), '', $this->url) . '">' . $this->text_prev . '</a></li>';
			} else {
				$output .= '<li class="pagin-prev"><a href="' . str_replace('{page}', $page - 1, $this->url) . '">' . $this->text_prev . '</a></li>';
			}
		}
		...
		if ($page < $num_pages) {
			$output .= '<li class="pagin-next"><a href="' . str_replace('{page}', $page + 1, $this->url) . '">' . $this->text_next . '</a></li>';
