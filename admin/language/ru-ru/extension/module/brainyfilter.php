...
$_['bf_signature']	                        = 'CyberShark'; 
$_['button_save_n_close']                   = 'Сохранить и закрыть'; 

// Top Menu
$_['top_menu_basic_settings']               = 'Настройки<span class="help">Settings used by all instances</span>';
$_['top_menu_module_instances']             = 'Настройки модуля<span class="help">Layouts & settings ovemides</span>';
$_['top_menu_add_new_instance']             = 'Добавить новый модуль'; 
...
// Help
$_['help_about']                            = 'О фильтре';
$_['help_faq_n_trouleshooting']             = 'Частые вопросы и проблемы';
$_['help_about_content']                    = 'После изменений в Атрибутах товаров нужно ОБЯЗАТЕЛЬНО обновлять кэш фильтра в Настройках!';
