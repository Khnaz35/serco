															...
															<tr id="payment_address_<?php echo $field['id']; ?>_input" 
																...
																<td>
																	...
																	<?php if($setting['step']['payment_address']['fields'][$field['id']]['type'] == 'text' 
																		...
																		<?php if($setting['step']['payment_address']['fields'][$field['id']]['custom']) { ?><a class="btn btn-primary btn-block" href="<?php echo $custom_field; ?>"><i class="fa fa-pencil"></i> <?php echo $text_custom_field; ?></a><?php }else{ ?> <input class="form-control pull-right" placeholder="<?php echo $setting['step']['payment_address']['fields'][$field['id']]['type'] ?>" type="<?php echo $setting['step']['payment_address']['fields'][$field['id']]['type'] ?>" name="<?php echo $id; ?>_setting[step][payment_address][fields][<?php echo $field['id']; ?>][value]" value="<?php echo (isset($setting['step']['payment_address']['fields'][$field['id']]['value'])) ? $setting['step']['payment_address']['fields'][$field['id']]['value'] : ''; ?>" /><?php } ?>
															...
															<tr id="shipping_address_<?php echo $field['id']; ?>_input" class="sort-item <?php echo ($field['type'] == 'system')? 'hide' : ''; ?>" sort-data="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['sort_order']) ? $setting['step']['shipping_address']['fields'][$field['id']]['sort_order'] : ''); ?>">
																...
																<td>
																	...
																	<?php if($setting['step']['shipping_address']['fields'][$field['id']]['type'] == 'text' 
																		...
																		<input class="form-control pull-right" placeholder="<?php echo $setting['step']['shipping_address']['fields'][$field['id']]['type'] ?>" type="<?php echo $setting['step']['shipping_address']['fields'][$field['id']]['type'] ?>" name="<?php echo $id; ?>_setting[step][shipping_address][fields][<?php echo $field['id']; ?>][value]" value="<?php echo (isset($setting['step']['shipping_address']['fields'][$field['id']]['value'])) ? $setting['step']['shipping_address']['fields'][$field['id']]['value'] : ''; ?>" />
