		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-slideshow" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-resize"><?php echo $text_resize; ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="view" id="input-view" class="form-control">
                                <option value=""></option>
                                <?php foreach ($views as $module_view) {?>
                                    <?php if ($view == $module_view) { ?>
                                    <option value="<?php echo $module_view; ?>" selected="selected"><?php echo $module_view; ?></option>
                                    <?php } else { ?>
                                    <option value="<?php echo $module_view; ?>"><?php echo $module_view; ?></option>
                                    <?php } ?>
                                <?php } ?>
                            </select>
                        </div>
