          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              <div id="latest-product" class="well well-sm" style="height: 150px; overflow: auto;">
                ...
                <div id="latest-product<?php echo $product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product['name']; ?>
...
$('input[name=\'product_name\']').autocomplete({
	...
	select: function(item) {
		...
		$('#latest-product').append('<div id="latest-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="product[]" value="' + item['value'] + '" /></div>');	
	}
});
