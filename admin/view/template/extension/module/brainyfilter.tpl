...
<div id="bf-attr-value-popup" style="display: none;">
    <div class="box">
        <div class="heading clearfix">
            <h3><?php echo $lang->edit_values_sort_order; ?></h3>
            <div class="buttons">
                <button class="bf-auto-sort" data-type="number">0..9</button>
                <button class="bf-auto-sort" data-type="string">A..Z</button>
                <a onclick="BrainyFilterAdm.attrValues.save();" class="bf-button bf-save-btn" title="<?php echo $lang->button_save_n_close; ?>"><span class="icon"></span></a>
                <a onclick="BrainyFilterAdm.attrValues.closePopup();" class="bf-button bf-cancel-btn" title="<?php echo $lang->button_cancel; ?>"><span class="icon"></span></a>
            </div>
        </div>
    </div>
    <div class="bf-content">
        ...
        <?php foreach ($languages as $i => $language) : ?>
            <li class="tab" data-target="#tab-language-<?php echo $language['language_id']; ?>">
                <a>
                    <img src="view/image/flags/<?php echo $language['image']; ?>" /> 
                    <?php echo $language['name']; ?>
                </a>
