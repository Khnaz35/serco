...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_column_center'] = $this->language->get('text_column_center');
		$data['text_column_baner1'] = $this->language->get('text_column_baner1');
		$data['text_column_baner2'] = $this->language->get('text_column_baner2');
		$data['text_column_baner3'] = $this->language->get('text_column_baner3');
