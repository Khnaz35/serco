...
// @category  : OpenCart
// @module    : Smart Order Success Message
// @author    : OCdevWizard <ocdevwizard@gmail.com>
// @copyright : Copyright (c) 2015, OCdevWizard
// @license   : http://license.ocdevwizard.com/Noncommercial_Licensing_Policy.pdf

class ControllerOcdevwizardSmartOrderSuccessMessage extends Controller {

  private $error           = array();
  static  $_module_version = '2.0.0';
  static  $_module_name    = 'smart_order_success_message';
