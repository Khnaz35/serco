...
class ControllerCatalogInformation extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['help_bottom2'] = $this->language->get('help_bottom2');
		...
		if (isset($this->request->post['bottom2'])) {
			$data['bottom2'] = $this->request->post['bottom2'];
		} elseif (!empty($information_info)) {
			$data['bottom2'] = $information_info['bottom2'];
		} else {
			$data['bottom2'] = 0;
		}
