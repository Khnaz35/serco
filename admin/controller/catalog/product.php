...
class ControllerCatalogProduct extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
		...
		$data['text_jan_0'] = $this->language->get('text_jan_0');
		$data['text_jan_1'] = $this->language->get('text_jan_1');
		$data['text_jan_2'] = $this->language->get('text_jan_2');
		$data['text_jan_3'] = $this->language->get('text_jan_3');
