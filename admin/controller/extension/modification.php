...
class ControllerExtensionModification extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['modifications'][] = array(
				...
				'edit'			  => $this->url->link('extension/modification_edit', 'token=' . $this->session->data['token'] . '&modification_id=' . $result['modification_id'], true),
	...
	private function modificate()
	{
		$files = glob(DIR_SYSTEM . '*.install.php');
		foreach ($files as $file){
			include_once $file;
		}
	}
