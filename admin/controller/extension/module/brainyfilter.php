...
class ControllerExtensionModuleBrainyFilter extends Controller {
     ...
     */
    protected $model_extension_module_brainyfilter;
    ...
    public function install() {
        ...
        $this->model_extension_module_brainyfilter->addCustomIndexes();
        $this->model_extension_module_brainyfilter->createAttributeValueTable();
        $this->model_extension_module_brainyfilter->createProductAttrValueTable();
        $this->model_extension_module_brainyfilter->createTaxRateTable();
        $this->model_extension_module_brainyfilter->createFilterTable();
        $this->model_extension_module_brainyfilter->fillCacheTable();
        $this->model_extension_module_brainyfilter->fillTaxRateTable();
        
        $this->model_extension_module_brainyfilter->addDefaultLayout();
        
        $defaultLayout = $this->model_extension_module_brainyfilter->getDefaultLayout();
        ...
        if (version_compare(VERSION, '2.2.0.0', '>=')) {
            $this->model_extension_event->addEvent('brainyfilter', 'admin/model/catalog/product/addProduct/after', 'extension/module/brainyfilter/eventEditProduct');
            ...
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.add', 'extension/module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.edit', 'extension/module/brainyfilter/eventEditProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.product.delete', 'extension/module/brainyfilter/eventDeleteProduct');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.add', 'extension/module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.edit', 'extension/module/brainyfilter/eventEditReview');
            $this->model_extension_event->addEvent('brainyfilter', 'post.admin.review.delete', 'extension/module/brainyfilter/eventEditReview');
        }
    }
    ...
    public function uninstall() {
        ...
        $this->model_extension_module_brainyfilter->dropAttributeValueTable();
        $this->model_extension_module_brainyfilter->dropProductAttrValueTable();
        $this->model_extension_module_brainyfilter->dropTaxRateTable();
        $this->model_extension_module_brainyfilter->dropFilterTable();
        
        $this->model_extension_module_brainyfilter->removeDefaultLayout();
        
        $this->model_extension_module_brainyfilter->removeCustomIndexes();
        $this->load->model('extension/modification');
    ...
    public function eventEditProduct($productId)
    {
        ...
        $this->loadModel();
        $this->model_extension_module_brainyfilter->cacheProductProperties($productId);
    }
    
    public function eventDeleteProduct($productId) 
    {
        $args = func_get_args();
        if (count($args) > 1) {
            $productId = $args[2];
        ...
        $this->loadModel();
        $this->model_extension_module_brainyfilter->deleteProductProperties($productId);
    }
    
    public function eventEditReview($reviewId)
    {
        $args = func_get_args();
        if (count($args) > 1) {
            $reviewId = $args[2];
        ...
        $this->model_extension_module_brainyfilter->cacheProductProperties($review['product_id']);
    }
    ...
    public function index()
    {
        ...
        $this->_data['attributes'] = $this->model_extension_module_brainyfilter->getAttributes();
        
        $this->_data['filters'] = $this->model_extension_module_brainyfilter->getFilters();
        
	    $this->_data['options'] = $this->model_extension_module_brainyfilter->getOptions();
        
        $this->_data['categories'] = $this->model_extension_module_brainyfilter->getCategories();
        $this->_data['category_layouts'] = $this->model_extension_module_brainyfilter->detectCategoryLayouts();
        
        $this->_data['defaultLayout'] = $this->defaultLayoutSettings;
        $this->_data['defaultLayout']['layout_id'] = $this->model_extension_module_brainyfilter->getDefaultLayout();
    ...
    public function attributeValues()
    {
        ...
        if (isset($this->request->get['attr_id'])) {
            $values = $this->model_extension_module_brainyfilter->getAttributeValues($this->request->get['attr_id']);
            die(json_encode($values) );
        }
        
        // modifies sort order
        if (isset($this->request->post['sort_order'])) {
            $this->model_extension_module_brainyfilter->changeAttrValuesSortOrder($this->request->post['sort_order']);
            die('done');
        }
    ...
    private function _switchAttributeMode($data) 
    {
        ...
        if ($modeChanged || $isFirstEnabling) {
            if ($multiMode) {
                ...
                $this->model_extension_module_brainyfilter->attrSeparator = $separator;
            } else {
                $this->model_extension_module_brainyfilter->attrSeparator = false;
            }
            $this->model_extension_module_brainyfilter->fillCacheTable();
        }
    }
    ...
    private function _saveSettings($data) 
    {
        ...
        else 
        {
            ...
            if ($data['layout_enabled']) {
                ...
                $this->model_extension_module_brainyfilter->editLayoutModule($lModule);
            } else {
                $this->model_extension_module_brainyfilter->deleteLayoutModule($moduleId);
            }
...
//        }
    ...
    private function _applySettings() 
    {
        ...
        if (isset($this->request->post['bf']) && is_array($this->request->post['bf'])) {
            ...
            $enabledModules = $this->model_extension_module_brainyfilter->getEnabledLayoutModules();
    ...
    public function ocmodManager()
    {
        ...
        if (isset($this->request->post['bf'])) {
            ...
            $this->model_extension_module_brainyfilter->updateMod($data);
    ...
    public function modRefreshTrigger()
    {
        ...
        if ($this->model_extension_module_brainyfilter->enableMod($enable)) {
    ...
    {
        if (!isset($this->model_extension_module_brainyfilter)) {
            $this->load->model('extension/module/brainyfilter');
            $this->model_extension_module_brainyfilter = new ModelExtensionModuleBrainyFilter($this->registry);
        }
    }
}