...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->request->post['config_benefit_title_1'] = $this->request->post['config_langdata'][$front_language_id]['benefit_title_1'];
			$this->request->post['config_benefit_title_2'] = $this->request->post['config_langdata'][$front_language_id]['benefit_title_2'];
			$this->request->post['config_benefit_title_3'] = $this->request->post['config_langdata'][$front_language_id]['benefit_title_3'];
			$this->request->post['config_benefit_title_4'] = $this->request->post['config_langdata'][$front_language_id]['benefit_title_4'];
		...
		$data['entry_name'] = $this->language->get('entry_name');
             ...
             $data['entry_benefit_block_title'] = $this->language->get('entry_benefit_block_title');
             
             $data['entry_benefit_block_show'] = $this->language->get('entry_benefit_block_show');
             
             $data['entry_benefit_icon_1'] = $this->language->get('entry_benefit_icon_1');
             $data['entry_benefit_title_1'] = $this->language->get('entry_benefit_title_1');
             
             $data['entry_benefit_icon_2'] = $this->language->get('entry_benefit_icon_2');
             $data['entry_benefit_title_2'] = $this->language->get('entry_benefit_title_2');
             
             $data['entry_benefit_icon_3'] = $this->language->get('entry_benefit_icon_3');
             $data['entry_benefit_title_3'] = $this->language->get('entry_benefit_title_3');
             
             $data['entry_benefit_icon_4'] = $this->language->get('entry_benefit_icon_4');
             $data['entry_benefit_title_4'] = $this->language->get('entry_benefit_title_4');
		...
		$data['tab_store'] = $this->language->get('tab_store');
             ...
             $data['tab_benefits'] = $this->language->get('tab_benefits');
		...
		if (isset($this->request->post['config_benefit_title_1'])) {
			$data['config_benefit_title_1'] = $this->request->post['config_benefit_title_1'];
		} else {
			$data['config_benefit_title_1'] = $this->config->get('config_benefit_title_1');
		}

		if (isset($this->request->post['config_benefit_title_2'])) {
			$data['config_benefit_title_2'] = $this->request->post['config_benefit_title_2'];
		} else {
			$data['config_benefit_title_2'] = $this->config->get('config_benefit_title_2');
		}

		if (isset($this->request->post['config_benefit_title_3'])) {
			$data['config_benefit_title_3'] = $this->request->post['config_benefit_title_3'];
		} else {
			$data['config_benefit_title_3'] = $this->config->get('config_benefit_title_3');
		}

		if (isset($this->request->post['config_benefit_title_4'])) {
			$data['config_benefit_title_4'] = $this->request->post['config_benefit_title_4'];
		} else {
			$data['config_benefit_title_4'] = $this->config->get('config_benefit_title_4');
		}
		...
		$data['placeholder'] = $this->model_tool_image->resize('no_image.png', 100, 100);
    		...
    		if (isset($this->request->post['config_benefit_icon_1'])) {
    			$data['config_benefit_icon_1'] = $this->request->post['config_benefit_icon_1'];
    		} else {
    			$data['config_benefit_icon_1'] = $this->config->get('config_benefit_icon_1');
    		}
    		if (isset($this->request->post['config_benefit_icon_1']) && is_file(DIR_IMAGE . $this->request->post['config_benefit_icon_1'])) {
    			$data['thumb_benefit_icon_1'] = $this->model_tool_image->resize($this->request->post['config_benefit_icon_1'], 100, 100);
    		} elseif ($this->config->get('config_benefit_icon_1') && is_file(DIR_IMAGE . $this->config->get('config_benefit_icon_1'))) {
    			$data['thumb_benefit_icon_1'] = $this->model_tool_image->resize($this->config->get('config_benefit_icon_1'), 100, 100);
    		} else {
    			$data['thumb_benefit_icon_1'] = $this->model_tool_image->resize('no_image.png', 100, 100);
    		}
            
            $data['placeholder_benefit_icon_1'] = $this->model_tool_image->resize('no_image.png', 100, 100);
            
            
    		if (isset($this->request->post['config_benefit_icon_2'])) {
    			$data['config_benefit_icon_2'] = $this->request->post['config_benefit_icon_2'];
    		} else {
    			$data['config_benefit_icon_2'] = $this->config->get('config_benefit_icon_2');
    		}
    		if (isset($this->request->post['config_benefit_icon_2']) && is_file(DIR_IMAGE . $this->request->post['config_benefit_icon_2'])) {
    			$data['thumb_benefit_icon_2'] = $this->model_tool_image->resize($this->request->post['config_benefit_icon_2'], 100, 100);
    		} elseif ($this->config->get('config_benefit_icon_2') && is_file(DIR_IMAGE . $this->config->get('config_benefit_icon_2'))) {
    			$data['thumb_benefit_icon_2'] = $this->model_tool_image->resize($this->config->get('config_benefit_icon_2'), 100, 100);
    		} else {
    			$data['thumb_benefit_icon_2'] = $this->model_tool_image->resize('no_image.png', 100, 100);
    		}
            
            $data['placeholder_benefit_icon_2'] = $this->model_tool_image->resize('no_image.png', 100, 100);
            
            
    		if (isset($this->request->post['config_benefit_icon_3'])) {
    			$data['config_benefit_icon_3'] = $this->request->post['config_benefit_icon_3'];
    		} else {
    			$data['config_benefit_icon_3'] = $this->config->get('config_benefit_icon_3');
    		}
    		if (isset($this->request->post['config_benefit_icon_3']) && is_file(DIR_IMAGE . $this->request->post['config_benefit_icon_3'])) {
    			$data['thumb_benefit_icon_3'] = $this->model_tool_image->resize($this->request->post['config_benefit_icon_3'], 100, 100);
    		} elseif ($this->config->get('config_benefit_icon_3') && is_file(DIR_IMAGE . $this->config->get('config_benefit_icon_3'))) {
    			$data['thumb_benefit_icon_3'] = $this->model_tool_image->resize($this->config->get('config_benefit_icon_3'), 100, 100);
    		} else {
    			$data['thumb_benefit_icon_3'] = $this->model_tool_image->resize('no_image.png', 100, 100);
    		}
            
            $data['placeholder_benefit_icon_3'] = $this->model_tool_image->resize('no_image.png', 100, 100);
            
            
    		if (isset($this->request->post['config_benefit_icon_4'])) {
    			$data['config_benefit_icon_4'] = $this->request->post['config_benefit_icon_4'];
    		} else {
    			$data['config_benefit_icon_4'] = $this->config->get('config_benefit_icon_4');
    		}
    		if (isset($this->request->post['config_benefit_icon_4']) && is_file(DIR_IMAGE . $this->request->post['config_benefit_icon_4'])) {
    			$data['thumb_benefit_icon_4'] = $this->model_tool_image->resize($this->request->post['config_benefit_icon_4'], 100, 100);
    		} elseif ($this->config->get('config_benefit_icon_4') && is_file(DIR_IMAGE . $this->config->get('config_benefit_icon_4'))) {
    			$data['thumb_benefit_icon_4'] = $this->model_tool_image->resize($this->config->get('config_benefit_icon_4'), 100, 100);
    		} else {
    			$data['thumb_benefit_icon_4'] = $this->model_tool_image->resize('no_image.png', 100, 100);
    		}
            
            $data['placeholder_benefit_icon_4'] = $this->model_tool_image->resize('no_image.png', 100, 100);
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_telephone']) < 1) || (utf8_strlen($this->request->post['config_telephone']) > 100)) {
